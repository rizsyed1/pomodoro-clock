...
describe(('TimeAdjuster'), () => {
    it('when rendering Session Length should render a downwards-pointing FontAwesome arrow icon whose onClick callback decrements timeLeft length time by one minute', () => {
        ...
        const wrapper = mount(<TimeAdjuster time={AppWrapper.state().timeAdjusterWorkTime} downArrowClick={mockdownArrowClick} timeAdjusterName='Session Length' />);
        wrapper.find('.arrowDown').simulate('click');
        const wrapper2 =  mount(<TimeAdjuster time={AppWrapper.state().timeAdjusterWorkTime} downArrowClick={mockdownArrowClick} timeAdjusterName='Session Length' />);
    ...
    it('when rendering Session Length should should render a upwards-pointing FontAwesome arrow icon whose onClick callback increments timeLeft by one minute', () => {
        ...
        const wrapper = mount(<TimeAdjuster time={AppWrapper.state().timeAdjusterWorkTime} upArrowClick={mockUpArrowClick} timeAdjusterName='Session Length' />);
        wrapper.find('.arrowUp').simulate('click');
        const wrapper2 =  mount(<TimeAdjuster time={AppWrapper.state().timeAdjusterWorkTime} upArrowClick={mockUpArrowClick} timeAdjusterName='Session Length' />);
    ...
    it('when rendering Break Length should should render a downwards-pointing FontAwesome arrow icon whose onClick callback decrements timeLeft by one minute', () => {
        ...
        const wrapper = mount(<TimeAdjuster time={AppWrapper.state().timeAdjusterBreakTime} downArrowClick={mockDownArrowClick} timeAdjusterName='Break Length' />);
        wrapper.find('.arrowDown').simulate('click');
        const wrapper2 =  mount(<TimeAdjuster time={AppWrapper.state().timeAdjusterBreakTime} downArrowClick={mockDownArrowClick} timeAdjusterName='Break Length' />);
    ...
    it('when rendering Break Length should should render a upwards-pointing FontAwesome arrow icon whose onClick callback increments timeLeft by one minute', () => {
        ...
        const wrapper = mount(<TimeAdjuster time={AppWrapper.state().timeAdjusterBreakTime} upArrowClick={mockUpArrowClick} timeAdjusterName='Break Length' />);
        wrapper.find('.arrowUp').simulate('click');
        const wrapper2 =  mount(<TimeAdjuster time={AppWrapper.state().timeAdjusterBreakTime} upArrowClick={mockUpArrowClick} timeAdjusterName='Break Length' />);
